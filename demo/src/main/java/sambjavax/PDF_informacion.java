...
public class PDF_informacion {
    ...
    public void generatePDF(List<Informacion> data) throws IOException {
        ...
        try (PDDocument document = new PDDocument()) {
            ...
            PDType0Font font = PDType0Font.load(document, new File("/home/samy/Music/demo/src/main/java/sambjavax/fuentes"));
            ...
            document.save("/home/samy/Music/demo/src/main/java/sambjavax/descargasPDF/tabla_motocicletas.pdf");
        }
    }
